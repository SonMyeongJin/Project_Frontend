<template>
  <main>
    ...
    <div class="container px-4 py-5" id="featured-3">
      <h2 class="pb-2 border-bottom">게시판 [ Market ]</h2>
      <div class="row g-4 py-5 row-cols-1 row-cols-lg-3">
        ...
        <div class="feature col">
          ...
          <h3 class="fs-2 text-body-emphasis"> 추후 추가 예정</h3>
          <p>추후 추가 예정 </p>
          <a href="#" class="icon-link">
            Go to ~
            <svg class="bi"><use xlink:href="#chevron-right"/></svg>
    ...
    <div class="container px-4 py-5" id="hanging-icons">
      <h2 class="pb-2 border-bottom">마이페이지 [ My Page ]</h2>
      <div class="row g-4 py-5 row-cols-1 row-cols-lg-3">
        ...
        <div class="col d-flex align-items-start">
          ...
          <div>
            <h3 class="fs-2 text-body-emphasis">[예정] 내가 작성한 글</h3>
            <p>[예시] <br> 게시글 [2] <br> 댓글 [3]</p>
            <a href="#" class="btn btn-primary">
              수정하기
            </a>
          </div>
        ...
        <div class="col d-flex align-items-start">
          ...
          <div>
            <h3 class="fs-2 text-body-emphasis">출석 체크</h3>
            <p>구현방식 구상중 </p>
            <a href="#" class="btn btn-primary">
              출석하기
            </a>
